...
微博浅色、X 深色、Instagram 浅色。浏览页像源站时间线；缓存成功会写 `{platform}/{user_id}/index.html`。窗口里播不了的视频可以调系统播放器打开。
...
- `dist-electron\SocialArchiver-0.4.1-win.zip` — 解压后运行 `Social Archiver.exe`
...
| [DESIGN.md](DESIGN.md) | 微博浅色 / X 深色视觉规则（改界面时看） |
